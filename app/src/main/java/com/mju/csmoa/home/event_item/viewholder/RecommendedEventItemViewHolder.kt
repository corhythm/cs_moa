...
class RecommendedEventItemViewHolder(
    ...
    fun bind(itemEventItem: ItemEventItem) {
        ...
        with(binding) {
            // 상품 이름
            textViewItemRecommendedEventItemItemName.text = itemEventItem.itemName
            // 상품 가격
            textViewItemRecommendedEventItemItemPrice.text = "${itemEventItem.itemPrice}원"
            // 상품 실질 가격
            textViewItemRecommendedEventItemItemActualPrice.text =
                "(개당 ${itemEventItem.itemActualPrice}원)"
            // 상품 조회수
            textViewItemRecommendedEventItemViewCount.text = itemEventItem.viewCount.toString()
            // 상품 좋아요 개수
            textViewItemRecommendedEventItemLikeCount.text = itemEventItem.likeCount.toString()
            ...
            // 이벤트 타입 설정
            textViewItemRecommendedEventItemEventType.text = itemEventItem.itemEventType
