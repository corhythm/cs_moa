        ...
        binding!!.textInputEditTextSignUpConfirmPasswordInput.addTextChangedListener(object : TextWatcher {
            ...
            override fun onTextChanged(s: CharSequence, start: Int, before: Int, count: Int) {
                ...
                val password = Objects.requireNonNull(
                        binding!!.textInputEditTextSignUpPasswordInput.text).toString().trim { it <= ' ' }
                val confirmPassword = Objects.requireNonNull(
                        binding!!.textInputEditTextSignUpConfirmPasswordInput.text).toString().trim { it <= ' ' }
